const Header = () => {
  return (
    <div className="flex justify-evenly h-[64px] bg-[white] border-b-[1px] border-[#c6c4c4] pt-[12px] pr-[32px] pb-[12px] pl-[32px]">
      <span className="w-[360px] h-[28px] gap-[3px] flex  items-center justify-items-center self-center">
        <span className="w-[81px] text-xl leading-[28px] font-semibold">Payouts</span>
        <span>
          <svg
            width="14"
            height="14"
        ...
        <span className="font-[400px] text-[12px] leading-[16px]">How it works</span>
      </span>
      <span className="bg-[#F2F2F2] flex items-center w-[400px] h-[40px] px-3  pt-[9px] pb-[9px] gap-2 self-center rounded-[8px] ">
        <svg
          width="16"
          height="16"
          viewBox="0 0 16 16"
        ...
        <span className="bg-[#F2F2F2] font-[400px] leading-[22px]">
          <input type="text" className="bg-[#F2F2F2]" placeholder="Search features, tutorials, etc.," />
        </span>
      </span>
      <span className="w-[360px] h-[40px] gap-1 flex justify-end">
        <svg
          width="40"
          height="40"
          viewBox="0 0 40 40"
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clipPath="url(#clip0_92272_6204)">
        ...
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clipPath="url(#clip0_92272_6209)">
            <circle cx="20" cy="20" r="20" fill="#E6E6E6" />
            <path
